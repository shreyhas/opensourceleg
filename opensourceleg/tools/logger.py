...
class Logger(logging.Logger):
    ...
    def __del__(self) -> None:
        """
        Closes the data log file when the object is deleted.
        """
        self._file.close()


# LOGGER = Logger(file_path="./hey", log_format="[%(asctime)s] %(levelname)s: %(message)s")
...
if __name__ == "__main__":
    ...
    local_logger.add_attributes(locals(), ["local_variable_2"])
